...
test('formatSubjectTitle: formats title covering A在线, A 在线, A动漫', () => {
  ...
  assert.equal(
    title1,
    '《葬送的芙莉莲》（葬送のフリーレン）动漫在线观看全集 - 1080P高清播放 · Animaku',
  )
  assert.ok(title1.includes('葬送的芙莉莲'))
  assert.ok(title1.includes('动漫在线观看全集'))

  // Case 2: without alternate name
  const title2 = formatSubjectTitle('鬼灭之刃')
  assert.equal(
    title2,
    '《鬼灭之刃》动漫在线观看全集 - 1080P高清播放 · Animaku',
  )
  ...
  assert.equal(
    title3,
    '《进击的巨人》动漫在线观看全集 - 1080P高清播放 · MySite',
  )
  ...
  assert.equal(
    title4,
    '《BLEACH》动漫在线观看全集 - 1080P高清播放 · Animaku',
  )
})
...
test('formatSubjectDescription: leads with intent keywords and truncates summary cleanly', () => {
  ...
  assert.equal(
    desc1,
    '《葬送的芙莉莲》动漫全集高清在线观看！Animaku 为您提供《葬送的芙莉莲》无广告弹幕在线播放与画质超分。',
  )
  ...
  assert.ok(desc2.startsWith('《葬送的芙莉莲》动漫全集高清在线观看！'))
