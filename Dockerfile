...
ARG VITE_NAV_SHOW_USER_MENU
ARG VITE_NAV_SHOW_HISTORY
ARG VITE_NAV_SHOW_THEME_TOGGLE
ARG VITE_NAV_SHOW_GITHUB
ARG VITE_GITHUB_URL
...
ENV BANGUMI_API=$BANGUMI_API \
    ...
    VITE_BAIDU_TONGJI_ID=$VITE_BAIDU_TONGJI_ID \
    VITE_SITE_URL=$VITE_SITE_URL \
    VITE_APP_VERSION=$VITE_APP_VERSION \
    VITE_DEFAULT_THEME=$VITE_DEFAULT_THEME \
    VITE_NAV_SHOW_USER_MENU=$VITE_NAV_SHOW_USER_MENU \
    VITE_NAV_SHOW_HISTORY=$VITE_NAV_SHOW_HISTORY \
    VITE_NAV_SHOW_THEME_TOGGLE=$VITE_NAV_SHOW_THEME_TOGGLE \
    VITE_NAV_SHOW_GITHUB=$VITE_NAV_SHOW_GITHUB \
