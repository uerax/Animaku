 ...
 * - xifan-next: 稀饭 next.xifanacg.com — Supabase RPC search + REST chapters + issue-web-playback (weight: 70)
 * - anime1: progressive + cookie adapter (needs MEDIA_FULL_PROXY=1) (weight: 60)
 * - libvio: release-page 类型 (libviogroup.github.io) — XPath search + XPath chapters + player_aaaa (weight: 60)
 * - mxdm: MacCMS-style third party (weight: 55)
 * - omofun: 211dm/omofuns — server search adapter (verify gate) + XPath chapters + player_aaaa (weight: 50)
